...
public class SimonSays extends KeyAdapter {
	...
	public void run() {
		...
		images.put(new Integer(KeyEvent.VK_UP), "hero_Up-2009.jpg");
		images.put(new Integer(KeyEvent.VK_RIGHT), "right1.jpg");
	...
	public void keyPressed(KeyEvent e) {
		...
		if(imageIndex==e.getKeyCode() && simonSays==true) {
			score ++;
			tries ++;
			speak("You got it right. You have a score of " + score);
			
		}
		else if(imageIndex==e.getKeyCode() && simonSays==false){
			tries ++;
			speak("You got it wrong");
		}
		else if(imageIndex!=e.getExtendedKeyCode() && simonSays==true) {
			tries ++;
			speak("You got it wrong");
		}
        else if(imageIndex!=e.getExtendedKeyCode() && simonSays==false) {
		score ++;
		tries ++;
		speak("You got it right. You have a score of " + score);
		}
